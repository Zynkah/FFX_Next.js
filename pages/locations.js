            ...
            <Card isPressable isHoverable variant="bordered">
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <Card.Divider />
                  <p>
                    The mechanical metropolis in which Tidus grew up. This city
                    is actually a dream summoned by Yu Yevon, who sought to
                    reproduce Zanarkand and its people as they existed a
                    thousand years ago. In early development the city was called
                    Registan.
                  </p>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    mother, and in this temple's Chamber of the Fayth the youth
                    Guado installed a statue representing Anima's Fayth.
                  </p>
                </AccordionDetails>
              </Accordion>
            </Card>
            ...
            <Card isPressable isHoverable variant="bordered">
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <Card.Divider />
                  <p>
                    A ship that belongs to the Al Bhed. It is used to go diving
                    in ruins for machina. Brother is the leader of the ship. You
                    visit this ship just once in the game, and you go on a
                    salvage hunt with Rikku and her crew.
                  </p>
                </AccordionDetails>
              </Accordion>
            </Card>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    abundant with nature. Its mountain regions are overgrown and
                    with thick vegetation, broken up by a number of free-flowing
                    waterfalls. Yuna and Wakka grew up in the elevated
                    settlement of Besaid Island.
                  </p>
                </AccordionDetails>
              </Accordion>
            </Card>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    Lying just beyond the forest, Kilika Temple is well known as
                    a spot where players can pray for a victory in blitzball.
                  </p>
                </AccordionDetails>
              </Accordion>
            </Card>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    Djose Temple. Return there and talk the woman at the top of
                    the stairs, she will ask you how many seagulls are flying
                    around. Tell her there are 11 total and she will gift you
                    with the Ace Wizard weapon.
                  </p>
                </AccordionDetails>
              </Accordion>
            </Card>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    all races and cultures come to participate in its blitzball
                    tournaments.
                  </p>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    with one path leading to the highlands and the other to the
                    Djose Highroad.
                  </p>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    technological civilization. When the purple moonlilies along
                    the riverbank are in full bloom, they attract countless
                    pyreflies during the night hours. The Hypello people ride
                    domestic creatures known as shoopufs, ferrying passengers
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    known as the Farplane. Specters of the deceased appear in
                    the Farplane when summoned by the living, resulting in many
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    like a summoner or a sender, or after they have accepted
                    their death. Those not sent to the Farplane may remain on
                    the mortal plane as the unsent or fiends, both types able to
                    send themselves by fulfilling a purpose failed to do in
                    life.
                  </p>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    Bikanel desert. It was built under Cid's direction to be the
                    home of the Al Bhed, whom a lot fo the rest of Spira despise
                    for not following the teachings of Yevon. This is where the
                    Al Bhed house the kidnapped summoners they hold to save them
                    from their fate.
                  </p>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    in the middle of the city. The city's defenses are strict.
                    No on can enter without passing over the Highbridge.
                  </p>
                </AccordionDetails>
              </Accordion>
            </Card>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <p>
                    ...
                    sapping the strength of anyone brave enough to walk its
                    path. Figures of the fayth, used to summon Dream Zanarkand,
                    line the summit cliffs.
                  </p>
                </AccordionDetails>
              </Accordion>
            </Card>
            ...
            <Card isPressable isHoverable variant="bordered">
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  <Card.Divider />
                  <p>
                    An optional dungeon located within a small group of islands
                    to the east of Spira's main continent. You can access this
                    area through the monster arena. Rather maze-like, like
                    inside Sin, this place must be mapped by the player.
                    Navigating the dark passages you encounter Master Tonberry
                    and Great Malboro, some of the toughest fiends in Spira. You
                    face off two bosses at the end, Omega and Ultima.
                  </p>
                </AccordionDetails>
              </Accordion>
            </Card>
