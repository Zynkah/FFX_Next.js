    ...
    <Layout>
      ...
      <Paper elevation={3}>
        ...
        <Image
          ...
          alt="Besaid Glyph"
        />
        <p>This temple has a Cloister of Trials you will have to complete.</p>
        <Link href={`/aeons/`}>
          <Image
        ...
        <p>It houses the Aeon Valefor, which is the first Aeon Yuna obtains.</p>
      </Paper>
      <Paper elevation={3}>
        <h3>Kilika Temple</h3>
        <Image
      ...
      <Paper elevation={3}>
        ...
        />
        <p>
          After passing through the Macalania Woods you will reach the temple.
        </p>
        <Image
      ...
      <Paper elevation={3}>
        ...
        />
        <p>
          Baaj Temple is a hidden location that can be found by using the search
          command while looking at the world map on the Airship.
        </p>
        <Image
        ...
        />
        <p>
          In order to break the seal at the front of this room you will need to
          activate the six statues located in this room.
        </p>
        <Link href={`/aeons/`}>
          <Image
        ...
        <p>
          Anima is the second of three option Aeons that you can obtain within
          Final Fantasy X. Anima can be obtained by traveling to Baaj Temple,
          one of the optional areas that you can explore once you reach the end
          of the game. You need to travel to Baaj Temple and unlock the Chamber
          of the Fayth at the back of the temple in order to obtain Anima.
        </p>
      </Paper>
      <Paper elevation={3}>
        ...
        />
        <p>
          You will find this cave in the Calm lands before you enter the path to
          Mt. Gagezet.
        </p>
        <Image
        ...
        />
        <p>
          You will have to clear your way through the cave and reach the end
          where the teleportation pads are located.
        </p>
        <Link href={`/aeons/`}>
          <Image
