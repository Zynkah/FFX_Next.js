  ...
  return (
    <Layout>
      ...
      <Typography variant="body1" component="p">
        ...
        and watched over her for the next ten years. His horn, the pride of a
        Ronso, was broken by his rival Biran and the resulting shame forced
        Kimahri to flee his hometown of Gagazet. Despite this, he overcomes his
        trauma to protect Yuna on her pilgrimage. A young warrior of the Ronso
      ...
      <Typography variant="body1" component="p">
        Kimahri is versatile character. The fact that he begins in the center of
        the Sphere Grid is an advantage, because you can then choose any
      ...
      <Typography variant="body1" component="p">
        ...
        choose a path of another character for Kimahri to emulate and unlock it
        using a Lv. 1 Key Sphere. If you want Kimahri to hit harder, follow
        Wakka's path. To make Kimahri a theif, follow Rikku's path. If you want
        Kimahri to become more agile and learn Haste, follow Tidus' path.
      ...
      <Typography variant="body1" component="p">
        ...
        Kimarhi and use Lancet. Kimahri's Overdive guage will instantly fill up
        whenever he learns a new technique.
      </Typography>
    </Layout>
  );
}
