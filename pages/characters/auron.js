  ...
  return (
    <Layout>
      ...
      <Typography variant="body1" component="p">
        ...
        Braska and Jecht. He also lost his own life, becoming an "unsent" who
        lingered in the world of the living. Auron joins Yuna's party as one of
        her guardians, wagering on the possibility that the children of his old
        friends might discover the truth and tell their own story. The legendary
        guardian who accompanied High Summoner Braska on the pilgrimage to
      ...
      <Typography variant="body1" component="p">
        Almost all of Auron's massive blades bear the Piercing ability, so you
        should bring Auron into battle when facing an enemy with a hard shell.
        Auron is ineffective at attacking nimble or aerial creatures, but his
        Break abilities reduce the attacking and defending power of most
        enemies.
      </Typography>
      <Spacer y={3} />
      <Divider />
      ...
      <Typography variant="body1" component="p">
        As Auron gains Sphere Levels, his HP and Strength will sky-rocket. Once
        he reaches the end of his section on the Sphere Grid, it's a good ide
        ato move him to into Tidus' section. by doing so, you can increas his
        Agility so he can attack more often.
      </Typography>
      <Spacer y={3} />
      <Divider />
      <Typography variant="h5" sx={{ marginTop: "1rem" }}>
      ...
      <Typography variant="body1" component="p" sx={{ marginTop: "2rem" }}>
        Overdrive: Bushido
        <br />
        Auron's Overdrives require the swift input of button combinations before
        time runs out. The quicker you can input the sequence, the more powerful
        Auron's attack becomes. Auron gains new Overdrives through the
        acquisition of recorded spheres that recount the journey of Auron's
        adventures with Braska. After defeating the Sperimorph at Lake
        Macalania, you can locate Jacht's and Braska's Spheres that are
        scattered across Spira. The status ailments are inflicted only when the
        command input is successful, although certain enemies can resist the
        ailments. If resisted, the damage inflicted is slightly increased to
        compensate.
      </Typography>
      <Spacer y={3} />
      <Divider />
      ...
      >
        ...
        <Table.Body>
          <Table.Row>
            ...
            <Table.Cell>Spherimorph boss fight, Macalania Forest</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>Jecht Sphere 2</Table.Cell>
            <Table.Cell>Besaid Village, to the right of the temple enterance</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>Jecht Sphere 3</Table.Cell>
            <Table.Cell>S.S. Liki, on the bridge (board at Besaid)</Table.Cell>
          </Table.Row>
          <Table.Row>
