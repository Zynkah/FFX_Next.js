  ...
  return (
    <Layout>
      ...
      <p>
        ...
        Yevon's shade remains as its core. Using this knowledge, she bestows the
        Final Summoning upon worthy summoners.
      </p>
      <hr />
      <h3>Gandof</h3>
      <Image 
      ...
      <p>
        ...
        in the valley of the Calm Lands.
      </p>
      <hr />
      <h3>Lord Braska</h3>
      <Image 
      ...
      <p>
        ...
        years before the events of the story, Braska embarked on a pilgrimage
        with Jecht and Auron to defeat that generation's Sin through the Final
        Summoning. He lost his life in the process, leaving deep scars on the
      ...
      <p>
        ...
        obtain the Final Summoning to defeat Sin. On her journey, she finds out
        the tradition of the pilgrimage is a scam and the Final Summoning does
        not stop Sin, it just resets the cycle, so she strays from the teachings
        of Yevon to find her own way to beat Sin. She is branded a traitor to
        Yevon but still continues her journey and defeats Sin for good at the
        end.
      </p>
      <hr />
      <h2>Summoners</h2>
      ...
      <p>
        ...
        motion, he is incapable to stopping what he is doing and creates Sin to
        protect his Dream Zanarkand. Sin's ultimate goal is to destroy all
      ...
      <p>
        ...
        weapon in an attempt to save her. Lenne followed him and died trying to
        stop him. They were caught by Bevelle's security forces and they
      ...
      <p>
        ...
        caused him to hate Spira and its people. Before the start of the story,
        he secretly murders his father Jyscal, succeeding him as a maester of
        Yevon and the leader of the Guado. Well aware that the Final Aeon must
        become the next Sin, he wants to exploit Yuna to become Sin itself so he
        can destroy Spira.
      </p>
      <hr />
      <h3>Isaaru</h3>
      ...
      <p>
        ...
        Nevertheless, he is forced to fight he on the order of the temples.
      </p>
      <hr />
      <h3>Dona</h3>
      <Image 
      ...
      <p>
        ...
        honesty and affects an air of self-importance, Dona is actually a sweet
        girl at her core.
      </p>
      <hr />
      <h3>Belgemine</h3>
      ...
      <p>
        ...
        communing with the fayth of the aeon Yojimbo. She remains on Spira as an
        unsent, dwelling in the cavern of that fayth, in the Calm Lands.
      </p>
      <hr />
      <h3>Zuke</h3>
      <Image 
