export const data = Object.freeze({
  character: [
    ...
    },
    {
      ...
      overdrive_title: "Grand Summoning",
      overdrive:
    ...
    },
    {
      ...
      overdrive_title: "Bushido",
      overdrive:
        "Auron's Overdrives require the swift input of button combinations before time runs out. The quicker you can input the sequence, the more powerful Auron's attack becomes. Auron gains new Overdrives through the acquisition of recorded spheres that recount the journey of Auron's adventures with Braska. After defeating the Sperimorph at Lake Macalania, you can locate Jacht's and Braska's Spheres that are scattered across Spira. The status ailments are inflicted only when the command input is successful, although certain enemies can resist the ailments. If resisted, the damage inflicted is slightly increased to compensate.",
    },
    {
      role: "Character",
      key: "4",
      ...
      overdrive_title: "Ronso Rage",
      overdrive:
        "Except for Jump, Kimahri learns enemy skills by using the Lancet ability. Once you see a monster using one of the abilities, bring Kimarhi and use Lancet. Kimahri's Overdive guage will instantly fill up whenever he learns a new technique.",
    },
    {
      role: "Character",
      key: "5",
      ...
      overdrive_title: "Slots",
      overdrive:
        "Wakka starts off with Elemental Reels adn acquires his other Overdives by winning blitzball games in both Leagues and Tournaments. Whenever you use Wakka's Elemental Reels Overdive, slot wheels start spinning. If you match all three wheels, then Wakka performs a double-elemental attack against a single, randomly-chosen enemy. If no wheels match up, Wakka perfomrs a physical attack against on randomly-chosen enemy. A similar concept is employed in his other Overdives.",
    },
    {
      role: "Character",
      key: "6",
      ...
      overdrive_title: "Fury",
      overdrive:
        "When Lulu hits Overdive, she can cast any black magic spell she knows multiple times whitout spending MP. Select the Fury command, and then choose a spell. Start rotating the right analog stick clockwise in full rotations as rapidly as possible. Depending on the spell you've chosen, the spell will cast on time for each several times you rotate the stick. Lulu's Overdive is available even when she's silenced, and isn't affect by any Shell or Reflect effects on enemies. Targets are randomly chosen.",
    },
    {
      role: "Character",
      key: "7",
      ...
      overdrive_title: "Mix",
      overdrive: "Rikku's Overdrives are created by mixing any two items.",
    },
  ],
});
